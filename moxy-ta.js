...
var MoxyTA = /** @class */ (function () {
    ...
    MoxyTA.prototype.scan = function () {
        ...
        Object.keys(this._analysis.wordFrequency).forEach(function (k) {
            _this._analysis.topWords.push({ word: k,
                frequency: _this._analysis.wordFrequency[k].frequency / _this._analysis.totals.totalWords });
        });
        ...
        Object.keys(this._analysis.alphabetFrequency).forEach(function (k) {
            _this._analysis.alphabetFrequencyPercent.push({ letter: k,
                frequency: _this._analysis.alphabetFrequency[k] / _this._analysis.totals.totalLetters });
        });
